...
const alternaCurtida = async (curtida, contentType) => {
    ...
    try {
        ...
        if(String(contentType).toUpperCase() == 'APPLICATION/JSON') {
            ...
            validar = validarCurtida(curtida)
...
const validarCurtida = (curtida) => {
    ...
    if (curtida.log_id == null || curtida.log_id == undefined || curtida.log_id == "" || typeof curtida.log_id !== "number") {

        MESSAGES.ERROR_REQUIRED_FIELDS.message += ' [LOG ID INCORRETO]'
        return MESSAGES.ERROR_REQUIRED_FIELDS

    } else if (curtida.usuario_id == null || curtida.usuario_id == undefined || curtida.usuario_id == "" || typeof curtida.usuario_id !== "number") {
